...
#CLEEN
apt-get -y remove exim4 exim4-base exim4-config exim4-daemon-light postfix apache2 nginx exim4 tor rpcbind avahi-daemon  exim4
 exim4-base exim4-config exim4-daemon-light avahi-daemon rsyslog logrotate -y &> /dev/null
#logs delete
crontab -l | { cat; echo "10 * * * *  for CLEAN in \$(find /var/log/* -type f); do cat /dev/null > \$CLEAN ; done "; } | cront
ab -
