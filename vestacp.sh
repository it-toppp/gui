...
wget https://raw.githubusercontent.com/Skamasle/sk-php-selector/master/sk-php-selector3.sh &> /dev/null
chmod +x sk-php-selector3.sh && bash sk-php-selector3.sh php70 php71 php72 php73 &> /dev/null
